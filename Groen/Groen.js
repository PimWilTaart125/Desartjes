...
export default class Groen extends Sprite {
  constructor(...args) {
    super(...args);

    this.costumes = [
      new Costume("uiterlijk1", "./Groen/costumes/uiterlijk1.svg", {
        x: 18.869991302490234,
        y: 15.75,
      }),
      new Costume("uiterlijk2", "./Groen/costumes/uiterlijk2.svg", {
        x: 83.58998489379883,
        y: 15.981249999999989,
      }),
    ];

    this.sounds = [new Sound("plop", "./Groen/sounds/plop.wav")];
  ...
  *whenIReceiveCheck() {
    if (this.touching(Color.rgb(52, 255, 0))) {
