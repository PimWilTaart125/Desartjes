...
export default class Lichtblauw extends Sprite {
  constructor(...args) {
    super(...args);

    this.costumes = [
      new Costume("uiterlijk2", "./Lichtblauw/costumes/uiterlijk2.svg", {
        x: 59.389991760253906,
        y: 15.981249999999989,
      }),
      new Costume("uiterlijk1", "./Lichtblauw/costumes/uiterlijk1.svg", {
        x: 0,
        y: 0,
      }),
    ];

    this.sounds = [new Sound("plop", "./Lichtblauw/sounds/plop.wav")];
  ...
  *whenIReceiveCheck() {
    if (this.touching(Color.rgb(0, 252, 255))) {
